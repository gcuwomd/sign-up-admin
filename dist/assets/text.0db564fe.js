...
`,[g("strong",`
 ...
 `)]),_=Object.assign(Object.assign({},b.props),{code:Boolean,type:{type:String,default:"default"},delete:Boolean,strong:Boolean,italic:Boolean,underline:Boolean,depth:[String,Number],tag:String,as:{type:String,validator:()=>!0,default:void 0}}),V=S({name:"Text",props:_,setup(t){const{mergedClsPrefixRef:r,inlineThemeDisabled:o}=z(t),n=b("Typography","-text",R,D,t,r),i=f(()=>{const{depth:l,type:d}=t,u=d==="default"?l===void 0?"textColor":`textColor${l}Depth`:T("textColor",d),{common:{fontWeightStrong:a,fontFamilyMono:s,cubicBezierEaseInOut:c},self:{codeTextColor:h,codeBorderRadius:x,codeColor:p,codeBorder:m,[u]:y}}=n.value;return{"--n-bezier":c,"--n-text-color":y,"--n-font-weight-strong":a,"--n-font-famliy-mono":s,"--n-code-border-radius":x,"--n-code-text-color":h,"--n-code-color":p,"--n-code-border":m}}),e=o?W("text",f(()=>`${t.type[0]}${t.depth||""}`),i,t):void 0;return{mergedClsPrefix:r,compitableTag:P(t,["as","tag"]),cssVars:o?void 0:i,themeClass:e==null?void 0:e.themeClass,onRender:e==null?void 0:e.onRender}},render(){var t,r,o;const{mergedClsPrefix:n}=this;(t=this.onRender)===null||t===void 0||t.call(this);const i=[`${n}-text`,this.themeClass,{[`${n}-text--code`]:this.code,[`${n}-text--delete`]:this.delete,[`${n}-text--strong`]:this.strong,[`${n}-text--italic`]:this.italic,[`${n}-text--underline`]:this.underline}],e=(o=(r=this.$slots).default)===null||o===void 0?void 0:o.call(r);return this.code?C("code",{class:i,style:this.cssVars},this.delete?C("del",null,e):e):this.delete?C("del",{class:i,style:this.cssVars},e):C(this.compitableTag||"span",{class:i,style:this.cssVars},e)}});export{V as _,D as t};
